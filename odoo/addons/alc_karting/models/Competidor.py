...
class Competidor(models.Model):
    ...
    equipo = fields.Many2one('alc_karting.equipo', string='Equipo')
    carreras = fields.Many2many('alc_karting.carrera', string='Carreras en las que ha participado o participará')
